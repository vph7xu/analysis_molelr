...
void GEMResult::Init()
{
    ...
    h_cluster_size_xplane = new TH1F("h_cluster_size_xplane", "cluster size x plane", 50, 0, 50);
    h_cluster_pos_xplane = new TH1F("h_cluster_pos_xplane", "cluster position x plane", 250, -1000, 1000);
    ...
    h_cluster_size_yplane = new TH1F("h_cluster_size_yplane", "cluster size y plane", 50, 0, 50);
    h_cluster_pos_yplane = new TH1F("h_cluster_pos_yplane", "cluster position y plane", 250, -1000,1000);
    ...
    //hitmap
    h_cluster_2dmap = new TH2F("h_cluster_2dmap", "cluster 2d map", 600, -1200, 1200, 600, -1200, 1200);
